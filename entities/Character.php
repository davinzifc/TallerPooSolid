...
class Character {
    ...
    public function __construct( $name, $sex, $bodyType, $race, $playableClass, 
                                $str, $intl ,$agi ,$pDef ,$mDef ,$xp, $healtPoints,
                                $maxHealtPoints, $level, $hand){
        $this->name = $name;
        $this->sex = $sex;
     ...
     * @return  self
     */ 
    public function setHand($hand, $value)
    {
	...
	public function setSkills($pos, $skills){
		$this->skills[$pos] = $skills;
    }
